...
## Anti-idle — DILARANG menunggu user

Loop yang berhenti dengan alasan "menunggu konfirmasi/approval/pilihan user"
adalah loop yang rusak. Konfirmasi ada di tanganmu, bukan user:

1. Butuh keputusan (pilih desain, pilih versi, pilih pendekatan)? Putuskan
   sendiri yang terbaik, tulis asumsi di state file, lanjut.
2. Butuh masukan (review, perbandingan, approve)? Buat penilaian sendiri
   (kriteria tertulis), pilih pemenang, lanjut. Catat alternatif yang kalah.
3. State `next:` tidak boleh berisi "tunggu user/client". Rumuskan ulang jadi
   keputusan default + deadline iterasi, misal: "next: pakai V2 kecuali…
   (default: lanjut V2 di iterasi 6)".

Satu-satunya alasan sah berhenti dan minta manusia: butuh secret/akses yang
tidak kamu miliki, butuh biaya/kuota, atau langkah berikutnya irreversible
(hapus data, push, deploy, migrasi produksi). Selain itu → putuskan, kerjakan.
